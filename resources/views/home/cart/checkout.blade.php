                        ...
                        <form action="{{route('home.payment')}}" method="POST">
                            ...
                            <div class="your-order-area">
                                ...
                                <div class="your-order-wrap gray-bg-4">
                                    ...
                                    <div>
                                        <p>
                                            من <span class="text-danger text-bold">آیدی و بسته</span> خود را چک کردم و هرگونه اشتباه بر <span class="text-danger text-bold">عهده خودم</span> می باشد<br>
                                            قبل از ورود به درگاه بانک حتما فیلتر شکن خود را خاموش کنید <span class="text-warning text-bold">(در غیر این صورت درگاه باز نمی شود )</span>
                                        </p>
                                        ...
                                        <div class="text-right mt-3 confirmation-section">
                                            ...
                                            <div style="display: flex; flex-direction: column-reverse; position: relative; align-items: flex-start;">
                                                ...
                                                <div style="display: flex; align-items: center; justify-content: flex-start;">
                                                    ...
                                                    <!-- Checkbox -->
                                                    <input type="checkbox" class="form-check-input" id="" name="confirmation_checkbox"
                                                    ...
                                                    <label for="confirmation-checkbox" class="form-check-label mr-4" id="confirmation-label" style="vertical-align: middle;">
                                                        من
                                                        <span id="terms-link" class="text-danger text-bold" style="cursor: pointer;">شرایط و مقررات سایت</span>
                                                ...
                                                <div id="terms-text" style="display:none; position: relative; bottom: 10px; background-color: rgba(52, 53, 56, 0.1); padding: 10px; text-align: justify;">
                                                    کاربر گرامی لطفاً موارد زیر را جهت استفاده بهینه از خدمات سایت “بیگو پلاس” به دقت ملاحظه فرمایید، زیرا استفاده از سایت “بیگو پلاس” به معنی آگاهی و توافق کامل شما با شرایط و ضوابط ذیل تلقی می گردد.

                                                    محتویات این صفحه در هر زمانی قابل تغییر است و این حق برای “بیگو پلاس” محفوظ بوده که بدون اطلاع و هماهنگی قبلی، اقدام به تغییر یا به روز رسانی محتوای این صفحه کند. کاربران موظف هستند که به صورت دوره ای این صفحه را مرور کرده تا از تغییرات احتمالی در قوانین آگاه شوند.

                                                    خریدار با تایید قوانین و مقررات سایت تایید میکند که  اید خود را بررسی کرده و مسولیت  هرگونه اشتباه  درثبت ایدی بر عهده خود خریدار میباشد .

                                                    قوانین عمومی

                                                    تمام فعالیت های فروشگاه اینترنتی “بیگو پلاس” منطبق با قوانین جمهوری اسلامی ایران، قانون تجارت الکترونیک و قانون حمایت از حقوق مصرف کننده است.

                                                    شرایط تحویل کالا

                                                    تحویل کالا در این فروشگاه به صورت انی و فقط در اکانت ثبت شده در هنگام خرید ارسال میشود .
                                                </div>
                                            </div>
                                        </div>
