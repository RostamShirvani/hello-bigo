                                    ...
                                    <div class="ht-product-image-wrap">
                                        ...
                                        <div class="ht-product-action">
                                            <ul>
                                                    ...
                                                    @if(auth()->check() && $product->checkUserWishlist(auth()->id()))
                                                        <a href="{{route('home.wishlist.remove', $product->id)}}">
                                                            ...
                                                            <span class="ht-product-action-tooltip">
                                                                به لیست علاقه مندی ها اضافه شده
                                                            </span>
                                                        </a>
                                                ...
                                                <li>
                                                    <a href="{{route('home.compare.add', $product->id)}}"><i
                                            ...
                                            <div class="ht-product-price">
                                                @if($product->check_quantity)
                                                    @if($product->check_sale)
                                                        <span class="new">
                                                          {{number_format($product->check_sale->sale_price)}}
                                                          تومان
                                                        </span>
                                                        <span class="old">
                                                          {{number_format($product->check_sale->price)}}
                                                          تومان
                                                        </span>
                                                    @else
                                                        <span class="new">
                                                          {{number_format($product->check_price->price)}}
                                                          تومان
                                                        </span>
                                                    @endif
                                                @else
                    ...
                    <div class="col-lg-6 col-md-6 text-right">
                        <div class="single-banner mb-30 scroll-zoom">
                            ...
                            <div
                                ...
                                <h3>{{$banner->title}}</h3>
                                <h2>{{$banner->text}}</h2>
                                <a href="{{$banner->button_link}}">فروشگاه</a>
                            </div>
                        </div>
                    </div>
                @endforeach
