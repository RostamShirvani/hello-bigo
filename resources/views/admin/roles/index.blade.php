    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            <div class="mb-4 d-flex flex-column text-center flex-md-row justify-content-md-between">
                <h5 class="font-weight-bold mb-3 mb-md-0">لیست نقش های کاربری ({{ $roles->total() }})</h5>
                <div>
                        ...
                        <tr>
                            ...
                            <th>
                                <a class="btn btn-sm btn-outline-success"
                                   href="{{route('admin.roles.show', $role->id)}}">نمایش</a>
                                <a class="btn btn-sm btn-outline-info mr-3"
                                   href="{{route('admin.roles.edit', $role->id)}}">ویرایش</a>
                            </th>
                        </tr>
                    @endforeach
                    </tbody>
