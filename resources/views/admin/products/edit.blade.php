                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" id="description" name="description"
                                  type="text" rows="4">{{$product->description}}</textarea>
                    </div>
                    {{-- Delivery Section --}}
                    <div class="col-md-12">
                        <hr>
                            ...
                            <div class="collapse mt-2" id="collapse-{{$variation->id}}">
                                <div class="card card-body">
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            <label>قیمت</label>
                                            <input class="form-control" type="text" value="{{$variation->price}}"
                                        ...
                                        <div class="form-group col-md-3">
                                            <label>sku</label>
                                            <input class="form-control" type="text" value="{{$variation->sku}}"
